import { skillsTech, experiences } from "../constants";
import {
  VerticalTimeline,
        ...
        <div className="mt-16 flex flex-wrap gap-12">
          {skillsTech.map((skill) => (
            <div key={skill.name} className="block-container w-20 h-20">
              ...
              <div className="group btn-front rounded-xl flex justify-center items-center cursor-pointer">
                <img
                  src={skill.imageUrl}
                  alt={skill.name}
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white text-wrap">{skill.name}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            high-quality, user-friendly solutions that enhance user engagement
